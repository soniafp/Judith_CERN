...
#./Judith -c coarseAlign -i $ALIG -r configs/reforig_HVCMOS.cfg -t configs/globalorig_HVCMOS.cfg
...
#./Judith -c process -i ${RCE_MASKED}.root -o ${RCE_PROCC}.root -r configs/reforig_HVCMOS.cfg -t configs/globalorig_HVCMOS.cfg -R ${RCE}-proccess-result.root
#./Judith -c process -i ${RCE_MASKED}.root -o ${RCE_PROCC}.root -r configs/reforig_HVCMOS.cfg -t configs/globalorig_HVCMOS.cfg -R ${RCE}-proccess-result.root
echo "-------------------process dut"
...
#./Judith -c analysis -i ${RCE_PROCC}.root -r configs/reforig_HVCMOS.cfg -t configs/globalorig.cfg -R ${RCE}-analysis-result.root #-n 10000
echo "-------------------Analysis dut"
