...
# 120 V full stats
export DUT=$PATH/dut-120V_runs-23-24-25-26-27-28-29-30-1-2-3-4-5-6-7_settings1
export RCE=$PATH/cosmic-120V_runs-23-24-25-26-27-28-29-30-1-2-3-4-5-6-7
export RCE_MASKED=${RCE}-mask
export RCE_PROCC=${RCE}-process
export DUT_PROCC=${DUT}_settings-process
...
#./Judith -c fineAlign -i $ALIG -r configs/reforig_July2015_15deg.cfg -t configs/globalorig_July2015.cfg -n 50000
#
...
echo "-------------------Analysis dut"
./Judith -c analysisDUT -i ${RCE_PROCC}.root -I ${DUT_PROCC}.root -r configs/reforig_July2015_15deg.cfg -d configs/dutXfab.cfg -t configs/globalorig.cfg -R ${DUT}_analysis-result-cutt0wider-align.root  
